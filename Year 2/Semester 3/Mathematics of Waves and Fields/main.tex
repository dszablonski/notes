...
The spherical wave equation is goverend by the laplacian in spherical polar coordinates. The spherical wave equation is given by,
\begin{equation}
...
\end{equation}
Let us for now consider the solution on the surface, $r = a$. Let us use a seperation of variables, 
\begin{equation}
...
\end{equation}
For the angular solution, we use seperation of variables,
\begin{equation}
...
\begin{aside}
	...
	\begin{equation}
		j(x) = \sqrt{\frac{\pi}{2x}}J_{l+\frac{1}{2}}(x).
	\end{equation}
\end{aside}
